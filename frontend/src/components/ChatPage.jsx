        ...
        <div className='flex ml-[16%] h-screen'>
            <section className='w-full md:w-1/4 my-8'>
                <div className='flex items-center p-2 gap-2'>
                    <Avatar>
                        <AvatarImage src={user?.profilePicture} alt="suggestedUser" />
                        <AvatarFallback>CN</AvatarFallback>
                    </Avatar>
                    <h1 className='font-bold mb-4 px-3 text-xl mt-2'>{user?.username}</h1>
                </div>
                        ...
                        suggestedUsers.map((suggestedUser) => {
                            ...
                            return (
                                <div onClick={() => dispatch(setSelectedUser(suggestedUser))} className='flex gap-3 items-center p-3 hover:bg-gray-100 cursor-pointer'>
                                    <Avatar>
                                        <AvatarImage src={suggestedUser?.profilePicture} alt="suggestedUser" />
                                        <AvatarFallback>CN</AvatarFallback>
                                    </Avatar>
